                ...
                >
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full rounded-lg bg-white/10 border border-white/15 px-3.5 py-2.5 text-[14px] text-forma-bone placeholder:text-forma-bone/30 focus:outline-none focus:border-forma-steel-blue/50 focus:ring-1 focus:ring-forma-steel-blue/30 transition-all disabled:opacity-50"
                    />
                  </div>
                  <MagneticButton strength={0.2}>
                    <button
                      type="submit"
                      disabled={formState === "loading"}
                      className="inline-flex items-center justify-center gap-2 rounded-lg bg-forma-bone text-forma-obsidian border border-forma-bone/20 px-5 py-2.5 text-[14px] font-medium transition-all duration-200 hover:bg-forma-bone/90 hover:shadow-md active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer whitespace-nowrap"
                    >
                      {formState === "loading" ? (
                        <>
