...
// ─── Simplified Forma App Window ─────────────────────────────────────────────
function FormaAppWindow() {
  return (
    <div
    ...
    >
      ...
      <div
        ...
        style={{ background: "#F0EDE8", borderBottom: "1px solid rgba(0,0,0,0.06)" }}
      >
        <div className="h-2 w-2 rounded-full" style={{ background: "#FF5F57" }} />
        <div className="h-2 w-2 rounded-full" style={{ background: "#FDBB2E" }} />
        <div className="h-2 w-2 rounded-full" style={{ background: "#27CA40" }} />
        <span
          className="flex-1 text-center"
          style={{ fontSize: 11, fontWeight: 500, color: "#1a1a1a", letterSpacing: 0.3 }}
        >
          Forma
        </span>
      </div>
      ...
      <div className="flex" style={{ height: 140 }}>
        ...
        <div
          ...
          style={{ width: 60, background: "#F5F2ED", borderRight: "1px solid rgba(0,0,0,0.05)" }}
        >
          <div
            style={{
              fontSize: 9,
        ...
        <div className="flex-1 px-2.5 py-2">
          <div
            ...
            style={{ borderBottom: "1px solid rgba(0,0,0,0.06)", paddingBottom: 4 }}
          >
            <span
              style={{
                fontSize: 10,
          ...
          {[
            ...
            { name: "IMG_4392.HEIC", dest: "~/Images" },
            { name: "notes.txt", dest: "~/Docs" },
          ].map((f, i) => (
            <div
              key={i}
          ...
          <div
            className="mt-2 rounded-[5px] text-center"
            style={{
              background: "#1a1a1a",
              color: "#fff",
              fontSize: 10,
