 ...
 *
 * Uses formaMagnetic easing for responsive cursor follow and formaReveal
 * for smooth reset on mouse leave. Respects prefers-reduced-motion via
 * getReducedMotionValue() -- the component using this hook should also
 * pass enabled=false when reduced motion is detected reactively.
 *
 * @example
 * ```tsx
 * function TiltCard() {
